...
export const createWebResolveAliases = (): AliasOptions => ({
  ...
  '@prodivix/assets': packageSource('assets'),
  '@prodivix/authoring': packageSource('authoring'),
  '@prodivix/code-language': packageSource('code-language'),
  '@prodivix/data': packageSource('data'),
  '@prodivix/data-http': packageSource('data-http'),
  '@prodivix/data-mock': packageSource('data-mock'),
  ...
  '@prodivix/runtime-remote': packageSource('runtime-remote'),
  '@prodivix/runtime-browser': packageSource('runtime-browser'),
  '@prodivix/server-runtime': packageSource('server-runtime'),
