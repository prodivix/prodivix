...
func rewindAgentEvaluationFinalizationAuthorityMigrations(
	...
	for _, statement := range []string{
		`DROP TABLE agent_evaluation_evidence_root_v45_roots`,
		`DROP TABLE agent_evaluation_authority_attestation_v45_roots`,
		`DROP TABLE agent_evaluation_provider_capability_observation_commit_links`,
		`DROP TABLE agent_evaluation_capability_specific_receipts`,
		`DROP TABLE agent_evaluation_provider_capability_observation_receipts`,
		`DROP TABLE agent_evaluation_optional_fact_authorities`,
		`DROP TABLE agent_evaluation_optional_capability_fact_sources`,
		`DROP TABLE agent_evaluation_plan_capability_probe_admission_links`,
		`DROP TABLE agent_evaluation_capability_probe_reference_receipts`,
		`DROP TABLE agent_evaluation_capability_probe_response_spools`,
		`DROP TABLE agent_evaluation_capability_probe_admissions`,
		`DROP TABLE agent_evaluation_runtime_fact_source_owner_registrations`,
		`DROP TABLE agent_evaluation_attempt_authority_commit_links`,
		`DROP TABLE agent_evaluation_attempt_authority_owner_receipts`,
		...
		`DROP TABLE agent_evaluation_validated_human_metric_observations`,
		`DROP TABLE agent_evaluation_validated_human_metric_observation_sets`,
		`DROP TABLE agent_evaluation_finalization_intents`,
