...
| `59.deterministic-scenario-replay-and-runtime-controls.md`                 | Accepted    | V3 Implemented locally / CI Evidence pending                                                          | canonical scheduler/control profile、fresh isolation、fixture/render controls、bounded ReplayRecord/first-divergence debugger、NodeGraph live bridge 与 Browser/Remote/Export/CI conformance已落地，本地 Gate通过。                                                                                                                                                                 | 取得 commit/CI identity；完整 trusted adapter/check-family matrix继续由 V6/V8关闭。                 |
...
| `69.real-model-evaluation-and-release-qualification.md`                    | Accepted    | Implemented / Deterministic CI Passed；Real-model Evidence Pending                                    | 128-case corpus、protected/rotating holdout、risk-stratified 10/30/100 repetition、24 context/16 media sentinels、11,640 minimum / current exact 14,040 journeys、grader/human review与 qualification expiry已冻结；production runner/workflow 已配置。                                                                                                                             | 取得三 Provider full matrix、protected holdout、human review 与 satisfied closure evidence。        |
