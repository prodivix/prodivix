...
- managed-cloud KMS adapter 与完整跨表面 Secret Gate。Backend static key-ring/data-key rotation first vertical 已关闭；Remote Terminal 已覆盖 transport-wide/cross-chunk、
