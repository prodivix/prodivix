...
| Data Authoring                | DataSource current/wire、Workspace typed document、Semantic contribution、PIR binding、Collection lifecycle transaction、invocation/registry/lifecycle kernel、HTTP 第一纵切、deterministic mock、stateful CRUD namespace 与 snapshot provision 已实现                                                                                                                                                                                                                                                                                                                                                                                                                                                            | schema/policy executor、standalone mutation/live、protocol importer 与完整产品旅程                   |
...
1. Renderer 与 standalone runtime 已能消费 `DataLifecycleSnapshot`；React/Vite mock query 已从 exact
   snapshot provision 生成真实 loading/success/empty/error 并订阅刷新，但 mutation/live/policy 尚未完成，
   不能把该纵切描述为完整 Data runtime。
...
| `@prodivix/data`               | Data current model、invocation、adapter registry、lifecycle/policy kernel、Network correlation、protocol-neutral importer mapping                                                                          |
