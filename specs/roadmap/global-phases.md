...
- A11 已关闭 Backend Environment Secret at-rest KMS envelope/key rotation first vertical：每条 Secret 使用独立 data key，
  ...
  legacy direct-cipher migration 与旧 key retirement fence均已通过本地真实 PostgreSQL 并发 Gate。at-rest provider/key id不进入
